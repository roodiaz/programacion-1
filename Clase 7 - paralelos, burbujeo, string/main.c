...
void mostrarAlumnos(char nombre[],int legs[], int ages[], int n1[], int n2[], char sexs[], float averages[], int tam)
{
...
/*
void ordenarSexoLegajo (char nombre[],int legs[], int ages[], int n1[], int n2[], char sexs[], float averages[], int tam)
{
    int auxInt;
    int flag=0;
    float auxfloat;
