...
/*void mayorAlumnosPorCarrera(eAlumno vec[], int tam, eCarrera vecC[], int tamC)
{
    ...
    cargarDescCarrera(1000,vecC,tamC,des1);
    cargarDescCarrera(1001,vecC,tamC,des2);
    cargarDescCarrera(1002,vecC,tamC,des3);

    for(int i=0; i<tam; i++)
    {
        if(vec[i].idCarrera == 1000 && vec[i].isEmpty == 0)
        {
            cont1++;
        }
        if(vec[i].idCarrera == 1001 && vec[i].isEmpty == 0)
        {
            cont2++;
        }
        if(vec[i].idCarrera == 1002 && vec[i].isEmpty == 0)
        {
            cont3++;
        }
    }
    ...
    {
        printf("La carrera con mas inscriptos es %s con %d alumnos",des1,cont1);
    }
    else if(cont2 > cont1 && cont2 > cont3)
    {
        printf("La carrera con mas inscriptos es %s con %d alumnos",des2,cont2);
    }
    else
    {
        printf("La carrera con mas inscriptos es %s con %d alumnos",des3,cont3);
    }

}

void mayorPromedioPorCarrera(eAlumno vec[], int tam, eCarrera vecC[], int tamC)
{
