...
Employee* employee_newParameters(char* idStr , char* nameStr , char* jobStr , char* ageStr , char* workedHoursStr , char* dedicationStr )
{
    Employee* auxEmployee = employee_new();

    if( (auxEmployee != NULL) && (idStr != NULL) && (nameStr != NULL) && (jobStr != NULL) && (ageStr != NULL) && (workedHoursStr != NULL) && (dedicationStr != NULL) )
    {
        int auxId, auxAge, auxHours;
...
{
    printf("\n-------------------------------------------------------------------------------\n");
    printf("ID      NOMBRE        PROFESION       EDAD      HORAS TRABAJADAS     DEDICACION");
    printf("\n-------------------------------------------------------------------------------\n");
}
...
void employee_printEmployee(Employee* auxEmployee)
{
    if(auxEmployee != NULL)
    {
        ...
        printf("%d %12s %16s %9d %15d %20s\n", id, name, job, age, hours, dedication);
    }
}
